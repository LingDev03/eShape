...
def main(args):
    ...
    for epoch in range(args.epochs+1):
        ...
        for b in range(len(training_set_loader)):
            ...
            with torch.no_grad():
                ...
                best_train_loss = loss.cpu()
                best_train_accuracy = correct.cpu()
    ...
    with open(f"result/{args.dataset_name}_result.txt", "w") as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_folder', type=str, default="./", help='root folder to save results')
    ...
    parser.add_argument("--r", default=4, type=int, help="Shapelet expansion factor")
    parser.add_argument("--subset_ratio", default=0.2, type=float, help="Ratio of data used in round-1 shapelet filtering")
